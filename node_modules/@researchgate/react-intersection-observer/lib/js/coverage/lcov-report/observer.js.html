...
<html lang="en">
<head>
    <title>Code coverage report for observer.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> observer.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { parseRootMargin, shallowCompare } from './utils';
&nbsp;
...
export function unobserveElement(element, target) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (observerElementsMap.has(element.observer)) {
        const targets = observerElementsMap.get(element.observer);
        <span class="missing-if-branch" title="else path not taken" >E</span>if (targets.delete(element)) {
            if (targets.size &gt; 0) {
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Tue Apr 23 2019 14:40:30 GMT+0200 (Central European Summer Time)
</div>
</div>
